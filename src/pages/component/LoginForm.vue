    ...
    <div class="ad-content">
      <div class="form-container">
        ...
        <div class="company-logo">
          ...
          <img v-for="item of logos" :key="item.id" :src="item.url" alt="">
    ...
    data(){
      return{
        logos:[
          {
            'id':'01',
            'url':'/src/assets/image/0.jpg'
          },
          {
            'id':'02',
            'url':'../../assets/image/tb.png'
          },
          {
            'id':'03',
            'url':'http://localhost:8080/static/img/1688.png'
          },
          {
            'id':'04',
            'url':'http://localhost:8080/static/img/alipay.svg'
          },
          {
            'id':'05',
            'url':'http://localhost:8080/static/img/weibo.svg'
          },
          {
            'id':'06',
            'url':'http://localhost:8080/static/img/dingtalk.svg'
          }
        ]
      }
    },
...
<style lang="stylus" scoped>
  ...
  .data-from {
    width: 100%;
    height: 568px;
    background: url(../../assets/image/bg.cc6d7ad.jpg);
